...
4. If you are creating an Angular or React project, you will be prompted to choose a template from our list of [angular](https://github.com/pxblue/angular-cli-templates) or [react](https://github.com/pxblue/react-cli-templates)  templates to scaffold your project:
    ...
    -   Authentication: integrates the [react](https://www.npmjs.com/package/@pxblue/react-auth-workflow) or [angular](https://www.npmjs.com/package/@pxblue/angular-auth-workflow) auth-workflow login and registration screens plus everything from the routing template
